...
const PeliculasTomCruise = () => {
    ...
    const { peliculasTomCruise, modificarModalPelicula, handleModalPelicula } = useProyectoPeliculasProvider()
        ...
        <section className=" mt-2 p-2 lg:p-10 text-lg md:text-2xl xl:text-4xl">
            <div>
                <div>
                    ...
                    <h2 className="text-white mb-2 md:mb-5">Peliculas  Tom Cruise</h2>
                </div>

                <SwipePeliculas>

                    {
                        peliculasTomCruise.map(peli => (
