...
const PeliculasDramas = () => {

    const { peliculasDramas, modificarModalPelicula, handleModalPelicula } = useProyectoPeliculasProvider()
        ...
        <section className=" mt-2 p-2 lg:p-10 text-lg md:text-2xl xl:text-4xl">
            <div>
                <div>
                    ...
                    <h2 className="text-white mb-2 md:mb-5">Mejores Dramas</h2>
                </div>

                <SwipePeliculas>

                    {
                        peliculasDramas.map(peli => (
                            ...
                            <SwiperSlide key={peli.id}>
                                ...
                                <div className='w-full hover:opacity-90'>
                                    ...
                                    <div className='flex flex-col justify-center items-center absolute top-1 lg:top-3 right-1 lg:right-2 text-sm bg-black/60 rounded-full hover:bg-gray-900 '>
                                        <div className="text-white  md:m-1 h-3 w-3 md:h-5 md:w-5 lg:h-8 lg:w-8  hover:text-gray-300 cursor-pointer">
                                            <p
                                                onClick={() => {
...
export default PeliculasDramas
